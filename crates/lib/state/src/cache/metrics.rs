...
use vetric::{Buckets, Counter, EncodeLabelValue, Gauge, Histogram, LabeledFamily, Metrics};
...
#[vetric::register]
pub(super) static METRICS: vetric::Global<CacheMetrics> = vetric::Global::new();
