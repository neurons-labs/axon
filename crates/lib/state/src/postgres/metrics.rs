...
#[vetric::register]
pub(super) static CACHE_METRICS: vetric::Global<ValuesCacheMetrics> = vetric::Global::new();
...
#[vetric::register]
pub(super) static STORAGE_METRICS: vetric::Global<PostgresStorageMetrics> = vetric::Global::new();
