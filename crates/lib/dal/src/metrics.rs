...
#[vetric::register]
pub(crate) static REQUEST_METRICS: vetric::Global<RequestMetrics> = vetric::Global::new();
...
#[vetric::register]
pub(crate) static CONNECTION_METRICS: vetric::Global<ConnectionMetrics> = vetric::Global::new();
